...
var _isInteger = __webpack_require__(1);
...
exports.default = VuexSystemDatetime;

var _vuexSystimeStore = __webpack_require__(45);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

function VuexSystemDatetime(param) {
  return function (store) {
    var datetimeStore = JSON.parse((0, _stringify2.default)(_vuexSystimeStore.systemDatetimeStore));

    var moduleName = 'systime';
    var attribute = (0, _assign2.default)({}, param);
    if (attribute.moduleName) {
      moduleName = attribute.moduleName;
    }
    datetimeStore.state.moduleName = moduleName;
    _vuexSystimeStore.moduleParameter[moduleName] = { timeoutID: null, attribute: attribute };

    var cutoffTime = 10 * 1000;
    if (attribute.cutoffTime) {
      if (!(0, _isInteger2.default)(attribute.cutoffTime)) {
...
exports.systemDatetimeStore = exports.moduleParameter = undefined;
...
var moduleParameter = exports.moduleParameter = {};
var systemDatetimeStore = exports.systemDatetimeStore = {
  namespaced: true,
  state: {
    moduleName: null,
    cutoffTime: 0,
  ...
  actions: {
    updateOffsetTime: function updateOffsetTime(_ref, offsetTime) {
    ...
    updateTime: function updateTime(_ref2, param) {
      var state = _ref2.state,
          commit = _ref2.commit,
          dispatch = _ref2.dispatch;

      var now = Date.now();
      var calcTime = now + state.offsetTime;
      var timeoutTime = calcTime % state.cutoffTime;

      var oldTimeoutId = moduleParameter[state.moduleName].timeoutID;
      moduleParameter[state.moduleName].timeoutID = setTimeout(function () {
        dispatch('updateTime');
  ...
  mutations: {
    setOffsetTime: function setOffsetTime(state, offsetTime) {
      if (!(0, _isInteger2.default)(offsetTime)) {
        throw new Error('offsetTime is not integer', offsetTime);
      }
      state.offsetTime = offsetTime;
    },

    setSystemTime: function setSystemTime(state, time) {
      state.systemTime = time;
    },
    setLocalTime: function setLocalTime(state, time) {
